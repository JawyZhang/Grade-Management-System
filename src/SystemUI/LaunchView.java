...
public class LaunchView extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        bt_sub.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    Login(Integer.parseInt(id),password);
    ...
    private void Login(int id,String password) throws SQLException {

        String sql = "select password from ? where name = ? and password = ?";
